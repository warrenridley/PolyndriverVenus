  ...
  def __init__(self):
    ...
    dbus_tree = {
        'com.victronenergy.system': {
            ...
            '/SystemState/ChargeDisabled': dummy,
            '/SystemState/DischargeDisabled': dummy
        },
    ...
    self._dbusservice.add_path('/Dc/0/Temperature',       -1)
...
#----
  ...
  def _can_bus_txmit_handler(self):
    ...
    if (info_maxdischargecurrent == None):
      info_maxdischargecurrent = 50.0
    if (info_maxchargecurrent == None):
      info_maxchargecurrent = 50.0
    ...
    msg2 = can.Message(arbitration_id = CAN_tx_msg["BatSoC"],
      data=[int(self._bms_data.state_of_charge), 0x00, 0x64, 0x0, 0x00, 0x00, 0x00, 0x00],
      is_extended_id=False)
